...
public class BoardDAO {
	...
	public int insertBoard(BoardDTO dto) {
		...
		String fields = "num, name, pwd, subject, content, ipAddr";
		sql="INSERT INTO bbs (" + fields + ") VALUES (bbs_seq.NEXTVAL, ?, ?, ?, ?, ?)";
		try {
	...
	public int dataCount()  {
		...
		ResultSet rs = null;
		String sql;
		sql = "SELECT NVL(COUNT(num), 0) cnt FROM bbs";
