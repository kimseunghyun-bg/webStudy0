...
<script type="text/javascript">
  ...
  function sendBoard() {
        ...
        if(confirm("위 자료를 수정 하시겠습니까 ?")){
	        f.action = "<%=cp%>/bbs/update_ok.jsp?page=<%=pageNum%>";
...
<form name="boardForm" method="post">
  ...
  <tr align="left" height="40"> 
      ...
      <td width="500" style="padding-left:10px;">
        ...
        <input type="text" name="subject" size="75" maxlength="100" class="boxTF" value="<%=dto.getSubject()%>">
      </td>
  </tr>
  ...
  <tr align="left"> 
      ...
      <td width="500" valign="top" style="padding:5px 0px 5px 10px;"> 
        <textarea name="content" cols="75" rows="12" class="boxTA"><%=dto.getContent()%></textarea>
      </td>
  </tr>
  ...
  <table style="width: 600px; margin: 0px auto; border-spacing: 0px;">
     <tr height="45"> 
      <td align="center" >
        <input type="button" value=" 수정하기 " class="btn" onclick="sendBoard();">
        <input type="reset" value=" 다시입력 " class="btn" onclick="document.boardForm.subject.focus();">
        <input type="button" value=" 수정취소 " class="btn" onclick="javascript:location.href='<%=cp%>/bbs/list.jsp?page=<%=pageNum%>';">
      </td>
    </tr>
  </table>
</form>
