...
<tr height="40">
	...
	<td bgcolor="#ffffff" style="padding-left: 10px;">
		<input type="text" name="hak" class="boxTF" size="30" maxlength="10" value="<%=dto.getHak()%>" readonly="readonly" style="border: none;">
	</td>
</tr>
...
<tr height="40">
	...
	<td bgcolor="#ffffff" style="padding-left: 10px;">
		<input type="text" name="name" class="boxTF" size="30" maxlength="10" value="<%=dto.getName()%>">
	</td>
</tr>
<tr height="1" bgcolor="#cccccc"><td colspan="2"></td></tr>
...
<tr height="40">
	...
	<td bgcolor="#ffffff" style="padding-left: 10px;">
		<input type="text" name="birth" class="boxTF" size="30" maxlength="10" value="<%=dto.getBirth()%>">
	</td>
</tr>
<tr height="1" bgcolor="#cccccc"><td colspan="2"></td></tr>
...
<tr height="40">
	...
	<td bgcolor="#ffffff" style="padding-left: 10px;">
		<input type="text" name="kor" class="boxTF" size="30" maxlength="3" value="<%=dto.getKor()%>">
	</td>
</tr>
<tr height="1" bgcolor="#cccccc"><td colspan="2"></td></tr>
...
<tr height="40">
	...
	<td bgcolor="#ffffff" style="padding-left: 10px;">
		<input type="text" name="eng" class="boxTF" size="30" maxlength="3" value="<%=dto.getEng()%>">
	</td>
</tr>
<tr height="1" bgcolor="#cccccc"><td colspan="2"></td></tr>
...
<tr height="40">
	...
	<td bgcolor="#ffffff" style="padding-left: 10px;">
		<input type="text" name="mat" class="boxTF" size="30" maxlength="3" value="<%=dto.getMat()%>">
	</td>
...
<tr height="45">
	<td align="center">
		...
		<input type="button" value=" 수정취소 " class="btn" onclick="javascript:location.href='list.jsp';">	
	</td>
</tr>
</table>
</form>
